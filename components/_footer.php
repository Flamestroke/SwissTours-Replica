...
echo'<footer class="bg-dark">
      <div class="container py-4 py-lg-5">
        <div class="row justify-content-center">
          ...
          >
            ...
            <ul class="list-unstyled">
              ...
              <li><a href="signup_otp.php">SignUp</a></li>
              <li><a href="#">FAQ</a></li>
            </ul>
          </div>
          <div
          ...
          >
            ...
            <ul class="list-unstyled">
              <li><a href="components/tos.php">Terms of Services</a></li>
              <li><a href="components/tos.php">Terms of use</a></li>
              <li><a href="components/privpol.php">Privacy Policy</a></li>
            </ul>
          </div>
          <div
        ...
        >
          <p class="mb-0">Icons Made By <a href="https://icons8.com/" target="_blank">Icons8</a><p>
          <p class="mb-0">Copyright © 2023 Campus Concerns</p>
